...
income = st.number_input("Monthly Income (INR)", 10000, 200000, step=2000)
...
if st.button("Get Recommendation"):
    ...
    def recommend_portfolio(category):
        portfolios = {
            'Conservative': {
                'Equity': ['Axis Bluechip Fund'],
                'Debt': ['HDFC Short Term Debt Fund'],
                'Gold': ['SBI Gold Fund']
            },
            'Balanced': {
                'Equity': ['HDFC Mid Cap Opportunities Fund', 'Mirae Asset Hybrid Equity'],
